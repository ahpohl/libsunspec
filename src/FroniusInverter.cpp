...
bool FroniusInverter::SetStateCodeStr(StateCode_t &state)
{
	if (state.Model.find("Primo") != std::string::npos) {
		...
		case 766:
			...
			break;
		default:
			ErrorMessage = "Invalid Fronius Primo state code (" + std::to_string(state.St) + ")";
			return false;
		}
		...
		case 0:
			break;
		default:
			ErrorMessage = "Invalid Fronius Symo state code (" + std::to_string(state.St) + ")";
			return false;
		}
		...
		case 0:
			break;
		default:
			ErrorMessage = "Invalid Fronius Galvo state code (" + std::to_string(state.St) + ")";
			return false;
		}
		...
		case 0:
			break;
		default:
			ErrorMessage = "Invalid Fronius IG Plus state code (" + std::to_string(state.St) + ")";
			return false;
		}
