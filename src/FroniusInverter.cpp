...
bool FroniusInverter::SetStateCodeStr(StateCode_t &state) {
  if (state.Model.find("Primo") != std::string::npos) {
    ...
    case 247:
      ...
      break;
    case 249:
      state.StStr = "Arc Fault Cicruit Interrupter (AFCI) detected unplausibel "
                    "measurement values";
      break;
    case 301:
    ...
    default:
      ErrorMessage =
          "Invalid Fronius Primo state code (" + std::to_string(state.St) + ")";
      return false;
    }
    ...
    default:
      ErrorMessage =
          "Invalid Fronius Symo state code (" + std::to_string(state.St) + ")";
      return false;
    }
    ...
    default:
      ErrorMessage =
          "Invalid Fronius Galvo state code (" + std::to_string(state.St) + ")";
      return false;
    }
